...
This is the complete alphabetical list of 440 active sites supported by username-checker.

Upstream false-positive exclusions are applied by default. 38 excluded targets are kept in the bundled manifest for explicit debugging but are not listed here.
